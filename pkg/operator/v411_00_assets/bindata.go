...
// sources:
// bindata/v4.1.0/cluster-policy-controller/defaultconfig.yaml
...
var _v410ClusterPolicyControllerDefaultconfigYaml = []byte(`apiVersion: openshiftcontrolplane.config.openshift.io/v1
kind: OpenShiftControllerManagerConfig
`)

func v410ClusterPolicyControllerDefaultconfigYamlBytes() ([]byte, error) {
	return _v410ClusterPolicyControllerDefaultconfigYaml, nil
}

func v410ClusterPolicyControllerDefaultconfigYaml() (*asset, error) {
	bytes, err := v410ClusterPolicyControllerDefaultconfigYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v4.1.0/cluster-policy-controller/defaultconfig.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"v4.1.0/cluster-policy-controller/defaultconfig.yaml":             v410ClusterPolicyControllerDefaultconfigYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v4.1.0": {nil, map[string]*bintree{
		"cluster-policy-controller": {nil, map[string]*bintree{
			"defaultconfig.yaml": {v410ClusterPolicyControllerDefaultconfigYaml, map[string]*bintree{}},
		}},
